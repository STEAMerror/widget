<?php
    ...
    $responce = file_get_contents('https://api.openweathermap.org/data/2.5/weather?q=Vladimir,ru&APPID='.$key);
...
// $result = mysqli_query ($con, "SELECT * from `weatherparam` WHERE `id_city`=2");
